...
No recordings, CSV trajectories, videos, HSSD dataset, policy weights or Python environments are included. Supply those separately. Keep this checkout at `HUMANOID_VLA_MJ_ROOT`; install compatible Isaac Sim separately.
